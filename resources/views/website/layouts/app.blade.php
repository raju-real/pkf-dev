...
<head>
    ...
    <meta property="og:title" content="Global Accountancy Firms Network | PKF International" />
    <title>Global Accountancy Firms Network | PKF International</title>
...
<body>
    ...
    <div id="LogoBox" class="container">
        <a href="" id="Logo"
            style="background-image:url('{{ asset('assets/website/media/logo.png') }}');">PKF - Home</a>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li id="StickyLogo"><a href=""
                            style="background-image:url('{{ asset('assets/website/media/logo.png') }}');">PKF - Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link active" href="home.html" title="Home">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="news.html" title="News &amp; Events">News &amp; Events</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="people.html" title="People">People</a>
                    </li>
                </ul>
            </div>
        </div>
