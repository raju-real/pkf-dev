...
@section('title',"Add/Edit Service Category")
@push('css')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ "Add/Edit Service Category" }}</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <form action="{{ $route }}" class="form" method="POST" id="prevent-form" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label>Sub Category Name {!! starSign() !!}</label>
                                ...
                                <div class="col-12 text-right">
                                    <a href="{{ route('admin.service-subcategories.index') }}" class="btn btn-info">Back</a>
