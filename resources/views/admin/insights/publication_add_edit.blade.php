...
@section('title',"Add/Edit Publication")
@push('css')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ "Add/Edit Publication" }}</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <form action="{{ $route }}" class="form" method="POST" id="prevent-form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="customFile">Image (620x600, Max: 5MB) {!! starSign() !!}</label>
                                        <div class="custom-file">
                                            <input name="image" type="file"
                                                class="custom-file-input {!! hasError('image') !!}" accept=".jpg,.png,.jpeg" />
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="customFile">File (Max: 10MB) {!! starSign() !!}</label>
                                        <div class="custom-file">
