...
@section('title',"Add/Edit News Category")
@push('css')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ "Add/Edit News Category" }}</h2>
            </div>
        </div>
    </div>
</div>
                        ...
                        <form action="{{ $route }}" class="form" method="POST" id="prevent-form" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-right">
                                    <a href="{{ route('admin.news-categories.index') }}" class="btn btn-info">Back</a>
