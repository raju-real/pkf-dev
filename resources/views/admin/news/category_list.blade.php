...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">News Category List</h2>
            </div>
        </div>
    </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('admin.news-categories.edit',$data->id) }}">
                                                ...
                                                <form id="delete-event-category-{{ $data->id }}"
                                                    action="{{ route('admin.news-categories.destroy',$data->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
