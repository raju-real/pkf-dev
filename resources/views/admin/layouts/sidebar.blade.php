    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                ...
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.people-directories.index') }}">
                        <i data-feather="circle"></i>
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.service-categories.index') }}">
                        <i data-feather="circle"></i>
                        <span class="menu-item text-truncate" data-i18n="List">Category</span>
                    </a>
                </li>
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.service-subcategories.index') }}">
                        <i data-feather="circle"></i>
