<div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
        <li class="nav-item mr-auto"><a target="_blank" class="navbar-brand" href="{{ route('home') }}">
                <h2 class="brand-text">{{ strLimit(siteSetting()['company_name'], 10) ?? 'PKF BD' }}</h2>
            </a></li>
...
<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item">
            <a class="d-flex align-items-center single-menu" href="{{ route('admin.sliders.index') }}">
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.news.index') }}">
            ...
            <ul class="menu-content">
                ...
                <li>
                    <a class="d-flex align-items-center child-menu"
                        href="{{ route('admin.publication-categories.index') }}">
                        <i data-feather="circle"></i>
                        <span class="menu-item text-truncate" data-i18n="List">Category</span>
                    </a>
                </li>
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.departments.index') }}">
                        <i data-feather="circle"></i>
                ...
                <li>
                    <a class="d-flex align-items-center child-menu"
                        href="{{ route('admin.people-directories.index') }}">
                        <i data-feather="circle"></i>
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                ...
                <li>
                    <a class="d-flex align-items-center child-menu"
                        href="{{ route('admin.service-subcategories.index') }}">
                        <i data-feather="circle"></i>
                        <span class="menu-item text-truncate" data-i18n="List">Sub Category</span>
                    </a>
                </li>
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.services.index') }}">
                        <i data-feather="circle"></i>
        ...
        <li class="nav-item parent-menu">
            ...
            <ul class="menu-content">
                <li>
                    <a class="d-flex align-items-center child-menu" href="{{ route('admin.job-departments.index') }}">
                        <i data-feather="circle"></i>
                        <span class="menu-item text-truncate" data-i18n="List">Department</span>
                    </a>
                </li>
