...
<?php $__env->startSection('title','Publication Category List'); ?>
<?php $__env->startSection('content'); ?>
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Publication Category List</h2>
            </div>
        </div>
    </div>
    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <a href="<?php echo e(route('admin.publication-categories.create')); ?>" class="btn btn-primary">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('admin.publication-categories.edit',$data->id)); ?>">
                                                ...
                                                <form id="delete-event-category-<?php echo e($data->id); ?>"
                                                    action="<?php echo e(route('admin.publication-categories.destroy',$data->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\laragon\www\pkf-dev\resources\views/admin/insights/category_list.blade.php ENDPATH**/ ?>