...
<?php $__env->startSection('title',"Add/Edit Job"); ?>
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0"><?php echo e("Add/Edit Job"); ?></h2>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label>Department <?php echo starSign(); ?></label>
                                        <select name="department" class="form-control select2">
                                            <option value="">Select Department</option>
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($department->id); ?>"
                                                    <?php echo e((old('department') ?? (isset($data) ? $data->department_id : '')) == $department->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label>Location <?php echo starSign(); ?></label>
                                        <input type="text" name="location"
                                            value="<?php echo e(old('location') ?? $data->location ?? ''); ?>"
                                            class="form-control <?php echo hasError('location'); ?>" placeholder="Location" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input name="file" type="file"
                                                class="custom-file-input <?php echo hasError('file'); ?>" accept=".pdf" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label>Status <?php echo starSign(); ?></label>
                                        <select name="status" class="form-control select2">
                                            <option value="">Select Status</option>
                                            <option value="active" <?php echo e(old('status') == 'active' || (isset($data) && $data->status == 'active') ? 'selected' : ''); ?>>Active</option>
                                            <option value="in-active" <?php echo e(old('status') == 'in-active' || (isset($data) && $data->status == 'in-active') ? 'selected' : ''); ?>>In Active</option>
                                        </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\laragon\www\pkf-dev\resources\views/admin/career/job_add_edit.blade.php ENDPATH**/ ?>