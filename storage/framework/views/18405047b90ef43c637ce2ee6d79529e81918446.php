...
<head>
    ...
    <title><?php echo e(siteSetting()['company_name'] ?? 'PKF BD'); ?></title>
    ...
    <link href="<?php echo e(asset('assets/user/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.datatables.net/2.1.6/css/dataTables.dataTables.min.css">

    <!-- Main CSS File -->
    <link href="<?php echo e(asset('assets/user/css/main.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('assets/user/css/responsive.css')); ?>" rel="stylesheet">
</head>

<body class="index-page">
    <header id="header" class="header sticky-top <?php echo e(url()->current() === url('/') ? '' : 'heading-2'); ?>">
        <div class="branding d-flex align-items-center">
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        <?php echo $__env->make('website.layouts.menus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </ul>
        ...
        <div id="mySearchbar" class="mySearchbar">
            ...
            <div class="d-flex align-items-center">
                <span>Search:</span>
                <input type="text" name="SearchTerm" value="<?php echo e(request('SearchTerm')); ?>" class="form-control search-content-box"
                      placeholder="Search">
            </div>
        </div>
    </header>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 footer-links">
                            ...
                            <div class="social-links d-flex mt-4">
                                <a href="<?php echo e(siteSetting()['facebook_url'] ?? '#'); ?>"><i class="bi bi-facebook"></i></a>
                                <a href="<?php echo e(siteSetting()['linkedin_url'] ?? '#'); ?>"><i class="bi bi-linkedin"></i></a>
                                <a href="<?php echo e(siteSetting()['instagram_url'] ?? '#'); ?>"><i class="bi bi-instagram"></i></a>
                                <a href="<?php echo e(siteSetting()['wechat_url'] ?? '#'); ?>"><i class="bi bi-wechat"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 footer-links">
                            <h4>Services</h4>
        ...
        <div class="container copyright mt-4">
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <p>© <strong class="px-1 sitename"><?php echo e(siteSetting()['company_name'] ?? 'PKF'); ?></strong> 
                        <span><?php echo e(date('Y',strtotime(now()))); ?></span>
                        <span>.All Rights Reserved</span>
                    </p>
                </div>
                <div class="col-md-6 col-lg-8">
                    <p><?php echo siteSetting()['footer_text'] ?? ''; ?></p>
                </div>
            </div>
        </div>
...
<?php /**PATH W:\laragon\www\pkf-dev\resources\views/website/layouts/app.blade.php ENDPATH**/ ?>