                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="<?php echo e(route('admin.news.show',$data->slug)); ?>">
                                                    <i data-feather="eye" class="mr-50"></i>
                                                    <span>Details</span>
                                                </a>
                                                <a class="dropdown-item" href="<?php echo e(route('admin.news.edit',$data->id)); ?>">
                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item delete-data" data-id="<?php echo e('delete-event-news-'.$data->id); ?>" href="javascript:void(0);">
                                                    <i data-feather="trash" class="mr-50"></i>
                                                    <span>Delete</span>
                                                </a>
                                                <form id="delete-event-news-<?php echo e($data->id); ?>"
                                                    action="<?php echo e(route('admin.news.destroy',$data->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\laragon\www\pkf-dev\resources\views/admin/news/news_list.blade.php ENDPATH**/ ?>