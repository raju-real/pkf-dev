...
<?php $__env->startSection('title',"Add/Edit Service Category"); ?>
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0"><?php echo e("Add/Edit Service Category"); ?></h2>
            </div>
        </div>
    </div>
</div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12 text-right">
                                    <a href="<?php echo e(route('admin.service-categories.index')); ?>" class="btn btn-info">Back</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\laragon\www\pkf-dev\resources\views/admin/service/category_add_edit.blade.php ENDPATH**/ ?>