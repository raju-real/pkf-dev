...
<?php $__env->startSection('title',"Add/Edit Publication"); ?>
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0"><?php echo e("Add/Edit Publication"); ?></h2>
            </div>
        </div>
    </div>
</div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="customFile">Image (620x600, Max: 5MB) <?php echo starSign(); ?></label>
                                        <div class="custom-file">
                                            <input name="image" type="file"
                                                class="custom-file-input <?php echo hasError('image'); ?>" accept=".jpg,.png,.jpeg" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="customFile">File (Max: 10MB) <?php echo starSign(); ?></label>
                                        <div class="custom-file">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH W:\laragon\www\pkf-dev\resources\views/admin/insights/publication_add_edit.blade.php ENDPATH**/ ?>